;;; emr-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
If the defun is preceded by comments, move above them." t)
...
Show the refactor menu at point." t)
...
Library and project includes are kept separate." t)
...
Add or remove !important on the property at point." t)
...
Order autoloads alphabetically by their file, then by their function name." t)
...
Delete the let binding around point." t)
...
Replaces all usages in the current buffer." t)
(autoload 'emr-el-delete-unused-definition "emr-elisp" "\
Delete the definition form at point if it does not have usages." t)
