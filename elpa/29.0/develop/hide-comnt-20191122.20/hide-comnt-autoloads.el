;;; hide-comnt-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
(fn &optional HIDE/SHOW START END)" t)
(register-definition-prefixes "hide-comnt" '("hide/show-comments-" "with-comments-hidden"))

;;; End of scraped data
