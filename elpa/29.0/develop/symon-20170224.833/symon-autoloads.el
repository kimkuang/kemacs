;;; symon-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
`Symon mode' mode.  If the prefix argument is positive, enable
