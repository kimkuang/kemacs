;;; lsp-origami-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
Turn on `origami-mode' locally and try to enable `lsp-origami-mode'." t)
