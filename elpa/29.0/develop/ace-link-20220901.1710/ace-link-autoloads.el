;;; ace-link-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
Call the ace link function for the current `major-mode'" t)
(autoload 'ace-link-info "ace-link" "\
Open a visible link in an `Info-mode' buffer." t)
(autoload 'ace-link-help "ace-link" "\
Open a visible link in a `help-mode' buffer." t)
(autoload 'ace-link-man "ace-link" "\
Open a visible link in a `man' buffer." t)
(autoload 'ace-link-woman "ace-link" "\
Open a visible link in a `woman-mode' buffer." t)
...
(fn &optional EXTERNAL)" t)
(autoload 'ace-link-w3m "ace-link" "\
Open a visible link in an `w3m-mode' buffer." t)
(autoload 'ace-link-compilation "ace-link" "\
Open a visible link in a `compilation-mode' buffer." t)
(autoload 'ace-link-gnus "ace-link" "\
Open a visible link in a `gnus-article-mode' buffer." t)
(autoload 'ace-link-mu4e "ace-link" "\
Open a visible link in an `mu4e-view-mode' buffer." t)
(autoload 'ace-link-notmuch-plain "ace-link" "\
Open a visible link in a `notmuch-show' buffer.
Only consider the 'text/plain' portion of the buffer." t)
(autoload 'ace-link-notmuch-html "ace-link" "\
Open a visible link in a `notmuch-show' buffer.
Only consider the 'text/html' portion of the buffer." t)
(autoload 'ace-link-notmuch "ace-link" "\
Open a visible link in `notmuch-show' buffer.
Consider both the links in 'text/plain' and 'text/html'." t)
(autoload 'ace-link-org "ace-link" "\
Open a visible link in an `org-mode' buffer." t)
(autoload 'ace-link-org-agenda "ace-link" "\
Open a visible link in an `org-mode-agenda' buffer." t)
(autoload 'ace-link-xref "ace-link" "\
Open a visible link in an `xref--xref-buffer-mode' buffer." t)
(autoload 'ace-link-custom "ace-link" "\
Open a visible link in an `Custom-mode' buffer." t)
(autoload 'ace-link-addr "ace-link" "\
Open a visible link in a goto-address buffer." t)
(autoload 'ace-link-sldb "ace-link" "\
Interact with a frame or local variable in a sldb buffer." t)
(autoload 'ace-link-slime-xref "ace-link" "\
Open a visible link in an `slime-xref-mode' buffer." t)
(autoload 'ace-link-slime-inspector "ace-link" "\
Interact with a value, an action or a range button in a
`slime-inspector-mode' buffer." t)
(autoload 'ace-link-indium-inspector "ace-link" "\
Interact with a value, an action or a range button in a
`indium-inspector-mode' buffer." t)
(autoload 'ace-link-indium-debugger-frames "ace-link" "\
Interact with a value, an action or a range button in a
`indium-debugger-frames-mode' buffer." t)
(autoload 'ace-link-cider-inspector "ace-link" "\
Open a visible link in a `cider-inspector-mode' buffer." t)
