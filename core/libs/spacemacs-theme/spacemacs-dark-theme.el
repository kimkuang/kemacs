...
;; Set face.
(custom-set-faces
 '(default ((t (:background "#202020" :foreground "#30A339"))))
 ...
 '(ace-jump-face-foreground ((t (:background "darkorange" :foreground "#202020" :box (:line-width 1 :color "#333333") :weight ultra-bold))))
 ...
 ;; '(col-highlight ((t (:background "darkred")))) ;kim
 '(comint-highlight-input ((t (:background "#202020" :foreground "gold3" :weight bold))))
 ...
 '(completion-dynamic-face ((((class color) (background dark)) (:background "DarkOrange" :foreground "#202020"))))
 ...
 '(custom-button ((((type x w32 ns) (class color)) (:background "#202020" :foreground "#EE8822" :underline t))))
 '(custom-link ((((type x w32 ns) (class color)) (:background "#202020" :foreground "#EE8822" :underline t))))
 ...
 '(erm-syn-errline ((t (:background "#202020" :foreground "red" :underline t))))
 '(erm-syn-warnline ((t (:background "#202020" :foreground "yellow" :underline nil))))
 ...
 '(font-lock-comment-face ((((class color) (min-colors 88) (background dark)) (:foreground "DodgerBlue"))))
 ;; '(font-lock-comment-face ((((class color) (min-colors 88) (background dark)) (:foreground "gray30"))));;kim
 ...
 '(helm-ff-directory ((t (:background "#202020" :foreground "dodgerblue"))))
 '(helm-ff-dotted-directory ((t (:foreground "DodgerBlue"))))
 '(helm-ff-dotted-symlink-directory ((t (:foreground "DarkOrange"))))
 '(helm-ff-file ((t (:background "#202020" :foreground "darkgreen"))))
 '(helm-ff-invalid-symlink ((t (:background "#202020" :foreground "red"))))
 '(helm-ff-prefix ((t (:background "#202020" :foreground "yellow"))))
 '(helm-ff-symlink ((t (:foreground "DarkOrange4"))))
 '(helm-selection ((t (:background "darkred" :foreground "grey"))))
 '(helm-source-header ((t (:background "#202020" :foreground "gold" :underline t :height 1.1))))
 ...
 ;; '(hl-line ((t (:background "grey13")))) kim
 '(hl-line ((t (:background "darkred"))))
 ...
 '(line-number ((t (:background "#202020" :foreground "gray35"))))
 '(line-number-current-line ((t (:background "#202020" :foreground "gray70"))))
 ...
 '(org-ellipsis ((((class color) (background dark)) (:background "#202020" :foreground "Cyan" :strike-through nil))))
 '(org-hide ((((background dark)) (:foreground "#202020"))))
 ...
 '(reb-match-1 ((((class color) (background dark)) (:background "dodgerblue3" :foreground "#202020"))))
 '(reb-match-2 ((((class color) (background dark)) (:background "chartreuse3" :foreground "#202020"))))
 '(reb-match-3 ((((class color) (background dark)) (:background "sienna3" :foreground "#202020"))))
 '(region ((((class color) (min-colors 88) (background dark)) (:background "green4" :foreground "#202020"))))
 ...
 '(show-paren-match ((((class color) (background dark)) (:background "green" :foreground "#202020"))))
 ...
 '(speedbar-highlight-face ((((class color) (background dark)) (:background "LightGoldenrod" :foreground "#202020"))))
 ...
 '(vr/group-0 ((t (:background "red" :foreground "#202020"))))
 '(vr/group-1 ((t (:background "gold2" :foreground "#202020"))))
 '(vr/group-2 ((t (:background "dodgerblue" :foreground "#202020"))))
 '(vr/match-0 ((t (:background "green4" :foreground "#202020"))))
 '(vr/match-1 ((t (:background "green4" :foreground "#202020"))))
 ...
 '(w3m-form-button ((((type x w32 mac) (class color)) (:background "#202020" :foreground "LawnGreen" :box (:line-width -1 :color "#014500" :style released-button)))))
 ...
 '(w3m-header-line-location-content ((((class color) (background dark)) (:background "#202020" :foreground "Green"))))
 '(w3m-header-line-location-title ((((class color) (background dark)) (:background "#202020" :foreground "brown"))))
 '(w3m-history-current-url ((t (:background "#202020" :foreground "DodgerBlue"))))
 ...
 '(w3m-tab-background ((((type x w32 mac) (class color)) (:background "#202020" :foreground "#202020"))))
 ...
 '(w3m-tab-selected ((t (:inherit tabbar-default :background "#202020" :foreground "green2" :box (:line-width 1 :color "#10650F")))))
 '(w3m-tab-selected-background ((((type x w32 mac) (class color)) (:background "#202020" :foreground "#202020"))))
 '(w3m-tab-selected-retrieving ((((type x w32 mac) (class color)) (:background "#202020" :foreground "grey80" :box (:line-width -1 :color "Grey40" :style released-button)))))
 '(w3m-tab-unselected ((t (:inherit tabbar-default :background "#202020" :foreground "#10650F" :box (:line-width 1 :color "#10650F")))))
 '(w3m-tab-unselected-retrieving ((t (:inherit tabbar-default :background "#202020" :foreground "grey30" :box (:line-width 1 :color "grey30")))))
 '(w3m-tab-unselected-unseen ((t (:inherit tabbar-default :background "#202020" :foreground "DodgerBlue" :box (:line-width 1 :color "#10650F")))))
 ...
 '(web-mode-block-face ((t (:background "#202020"))))
 ...
 '(whitespace-highlight ((((class color) (background dark)) (:background "yellow2" :foreground "#202020"))))
